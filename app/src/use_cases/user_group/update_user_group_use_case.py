...
class UpdateUserGroupUseCase:
    ...
    def execute(self, user_id: int, group_id: int, user_group_data: dict) -> UserGroup:
        return self.user_group_repository.update_user_group(user_id, group_id, user_group_data)

    def get(self, user_id: int, group_id: int) -> UserGroup:
        return self.user_group_repository.select_user_group_by_id(user_id, group_id)
